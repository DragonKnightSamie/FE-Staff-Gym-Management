...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            { path: 'equipments', loadChildren: () => import('app/modules/admin/equipment/equipment.routes') },
            ...
            { path: 'inquiries', loadChildren: () => import('app/modules/admin/inquiry/inquiry.routes') },
        ]
    }
];
